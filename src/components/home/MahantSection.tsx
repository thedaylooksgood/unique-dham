...
export function MahantSection() {
  return (
    <section id="mahant" className="relative py-32 bg-parchment overflow-hidden">
      {/* Background patterns */}
            ...
            <div className="grid gap-4">
              {highlights.map((item, index) => (
                <BlurFade key={item.title} delay={0.7 + index * 0.1} direction="up">
                  <div className="flex items-center gap-6 p-6 bg-ivory rounded-2xl border border-saffron/5 shadow-sm transition-all hover:translate-x-2 hover:shadow-sacred-warm">
